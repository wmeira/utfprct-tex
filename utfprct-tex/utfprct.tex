...
%\bibliographystyle{abntex2-alf-en} % comentar para pt-br
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\include{./PreTexto/entradas-acronimos}%% Entradas da lista de abreviaturas, siglas e acrônimos - Comente para remover este item
